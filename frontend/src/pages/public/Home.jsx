    ...
    return (
        <div className="min-h-screen bg-primary text-text-main">
            ...
            <div className="max-w-6xl mx-auto px-4 py-10">
                <div className="bg-secondary border border-border-light rounded-2xl p-6 md:p-10">
                ...
                <div className="mt-4 grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                    {demoWatches.map((w) => (
                        <div key={w.id} className="bg-secondary border border-border-light rounded-2xl overflow-hidden">
                            ...
                            <div className="p-4">
                                ...
                                <button className="mt-3 w-full bg-black/5 hover:bg-white/15 rounded-lg py-2 text-sm">
                                    View Details (Public)
                                </button>
                            </div>
                        </div>
